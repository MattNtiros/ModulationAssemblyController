...
class ResourceTests(ossie.utils.testing.ScaComponentTestCase):
    """Test for all resource implementations in ModulationAssemblyController"""
...
if __name__ == "__main__":
    ossie.utils.testing.main("../ModulationAssemblyController.spd.xml") # By default tests all implementations
